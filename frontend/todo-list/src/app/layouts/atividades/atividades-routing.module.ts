import { AtividadesLayoutComponent } from './atividades-layout/atividades-layout.component';
...
const atividadesRoutes: Routes = [
  ...
  {
    path: '',
    component: AtividadesLayoutComponent,
    children: [
      { path: 'abertas', component: ListarAtividadesAbertasComponent },
      { path: 'concluidas', component: ListarAtividadesComponent },
      { path: 'novo', component: AtividadesFormComponent },
      { path: 'edit/:id', component: AtividadesFormComponent },
    ],
  },
